...
range = 10;
% potential seeds: [306,291]  [679,175] [295,384] [727,220]
seed = [306,291;679,175;293,381; 727,220];
...
imshow(I);
    for pt = 1 : size(seed, 1)
        hold on
        plot(seed(pt,1), seed(pt,2), 'r.','MarkerSize', 10);
...
save('trace_t6.mat', 'trace_matrix', 'newSeed', 'dir_vec');
